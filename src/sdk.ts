...
export interface SdkConfig {
    serverUrl: string, // your sso server URL
    clientId: string, // the Client ID of your sso application, e.g., "014ae4bd048734ca2dea"
    appName: string, // the name of your sso application, e.g., "app-casnode"
    organizationName: string // the name of the sso organization connected with your sso application
    redirectPath?: string // the path of the redirect URL for your sso application, will be "/callback" if not provided
    signinPath?: string // the path of the signin URL for your sso applcation, will be "/api/signin" if not provided
...
class Sdk {
    ...
    public silentSignin(onSuccess: (message: any) => void, onFailure: (message: any) => void) {
        ...
        const handleMessage = (event: MessageEvent) => {
            ...
            if (message.tag !== "sso" || message.type !== "SilentSignin") {
                return;
            }
